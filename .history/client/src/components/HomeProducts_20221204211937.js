...
const Homeproducts = () => {
  return (
    <div className='homeDetail'>
      <div className='homeDetail-heading'>
        ...
        <div className='homeProducts'>
          <div className='homeProducts-detail'>
              <div className='image-square'>
                  <img 
                    src='https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=464&q=80' alt=''
                  />
